  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed overflow-hidden left-1/2 right-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[640px] h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none">
